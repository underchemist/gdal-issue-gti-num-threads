...
# docker run --rm -v $(pwd)/main.py:/scripts/main.py -e GDAL_NUM_THREADS=1 -e GTI_NUM_THREADS=1 --name gdal-issue-gti-num-threads ghcr.io/osgeo/gdal:ubuntu-full-latest-amd64 python /scripts/main.py
docker run \
    --rm \
